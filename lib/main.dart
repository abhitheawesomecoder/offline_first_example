...
import 'package:getx_ex/brick/models/customer.model.dart';
import 'package:getx_ex/brick/repository.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    Repository.configure('http://10.0.2.2:8080');
          ...
          ? Container(
              ...
              child: FutureBuilder(
                ...
                builder: (context, AsyncSnapshot<List<Customer>> customerList) {
                  ...
                  print("customerList.data");
                  print(customerList.data);
                  return ListView.builder(
                    itemCount: customers?.length ?? 0,
                    itemBuilder: (ctx, index) => customers?[index] == null
                        ? Container()
                        : CustomerTile(customers![index]),
                  );
                },
              ),
            )
